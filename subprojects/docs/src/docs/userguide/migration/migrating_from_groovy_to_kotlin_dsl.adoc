...
* Enabling the incubating <<multi_project_builds.adoc#sec:configuration_on_demand,configuration on demand>> feature is not recommended as it can lead to very hard-to-diagnose problems.
...
====
include::sample[dir="snippets/kotlinDsl/applying-plugins-declarative/groovy",files="build.gradle[]"]
include::sample[dir="snippets/kotlinDsl/applying-plugins-declarative/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/kotlinDsl/applying-plugins-imperative/groovy",files="build.gradle[]"]
include::sample[dir="snippets/kotlinDsl/applying-plugins-imperative/kotlin",files="build.gradle.kts[]"]
====
